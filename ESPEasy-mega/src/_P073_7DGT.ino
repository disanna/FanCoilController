...
void p073_FillBufferWithTime()
{
  ...
  p073_showbuffer[0] = p073_digit1;
  p073_showbuffer[1] = p073_digit2;
  p073_digit1 = (uint8_t)(sevendgt_minutes / 10);
  p073_digit2 = sevendgt_minutes - p073_digit1 * 10;
  p073_showbuffer[2] = p073_digit1;
  p073_showbuffer[3] = p073_digit2;
  p073_digit1 = (uint8_t)(sevendgt_seconds / 10);
  p073_digit2 = sevendgt_seconds - p073_digit1 * 10;
  p073_showbuffer[4] = p073_digit1;
  p073_showbuffer[5] = p073_digit2;
}
...
void p073_FillBufferWithDate()
{
  ...
  p073_showbuffer[6] = p073_digit1;
  p073_showbuffer[7] = p073_digit2;
}
...
void tm1637_ClearDisplay(uint8_t clk_pin, uint8_t dio_pin)
{
  ...
  tm1637_i2cWrite(clk_pin, dio_pin, 0);
  tm1637_i2cAck(clk_pin, dio_pin);
  tm1637_i2cWrite(clk_pin, dio_pin, 0);
  tm1637_i2cAck(clk_pin, dio_pin);
  tm1637_i2cWrite(clk_pin, dio_pin, 0);
...
{
  p073_spidata[0] = (byte)0;
  p073_spidata[1] = (byte)0;
  p073_spidata[1] = opcode;
  p073_spidata[0] = data;
